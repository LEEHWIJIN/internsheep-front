...
//  import { mapActions, mapGetters } from "vuex";
  export default{
      ...
      methods: {
        getResume(loginId){
          this.$http.get('http://106.10.46.121:10022/std/mypage/watchResume',{params:{sLoginID : loginId}}).then(res =>{
        ...
        // submitResume(){
        //   this.$http.post('http://106.10.46.121:10022/std/mypage/resume',{sNum:this.sNum,sName: this.sName}).then((response) => {
        //       this.sName = "";
        //       this.sNum="";
        //     })
        // },
