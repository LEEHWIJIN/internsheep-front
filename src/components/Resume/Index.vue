...
//  import { mapActions, mapGetters } from "vuex";
  export default{
      ...
      methods: {
        getResume(loginId){
          this.$http.get('http://10.41.83.255:8888/std/mypage/watchResume',{params:{sLoginID : loginId}}).then(res =>{
        ...
        // submitResume(){
        //   this.$http.post('http://10.41.83.255:8888/std/mypage/resume',{sNum:this.sNum,sName: this.sName}).then((response) => {
        //       this.sName = "";
        //       this.sNum="";
        //     })
        // },
