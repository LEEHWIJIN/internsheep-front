...
<script>
    export default{
        ...
        methods: {
            listApplyTerm(){
                this.$http.get('http://106.10.46.121:8888/admin/listApplyTerm').then((response)=>{
            ...
            submitApplyTerm(){
                this.$http.post('http://106.10.46.121:8888/admin/postApplyTerm',{applyStart:this.applyStart,applyEnd:this.applyEnd,applySemester:this.applySemester,applyOrder:this.applyOrder}).then((response)=>{
