...
<script>
  ...
  export default{
      ...
      methods: {
        applyStd(cName){
            this.$http.get('http://106.10.46.121:10022/std/mypage/applyStatus',{params:{sLoginID : this.user.loginId, applySemester : this.applyTerm.applySemester}}).then((response)=>{
            if(response.data != '0'){
