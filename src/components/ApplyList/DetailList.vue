...
<script>
  ...
  export default{
      ...
      methods: {
        applyStd(cName){
            this.$http.get('http://10.41.83.255:8888/std/mypage/applyStatus',{params:{sLoginID : this.user.loginId, applySemester : this.applyTerm.applySemester}}).then((response)=>{
            if(response.data != '0'){
